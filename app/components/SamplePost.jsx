...
const SamplePost = ({username, content, imagePath, likes, shares, comments, saved, created_At}) => {
  return (
    <div>
      <div className="w-[660px] px-9 py-4 mt-5 bg-white shadow-lg shadow-blue-200 rounded-3xl w-full">
        ...
        <p className="relative bottom-7">{content}</p>
        <div className="flex gap-5">
          {/* <div className="flex-1 h-50 bg-gray-200 rounded-3xl"></div>
          <div className="flex flex-col w-1/3">
            <div className="h-23 bg-gray-200 rounded-3xl"></div>
            <div className="mt-4 h-23 bg-gray-200 rounded-3xl"></div> */}
        ...
        <div className="flex justify-between">
          <div className="relative top-4">
            ...
            <p className="relative bottom-6 left-6 text-[15px] text-gray-500">
              {comments} Comments
            </p>
          </div>
        ...
        <div className="mt-4 border-t-2 border-gray-300 w-full place-self-center"></div>
        ...
        <div className="flex">
          ...
          <div className="relative flex justify-between top-3.5 left-3 rounded-xl h-9 w-140 bg-gray-100">
            <input placeholder="Write your comment..." className="relative left-3 text-sm text-gray-400 font-bold w-full border-none outline-none" />
